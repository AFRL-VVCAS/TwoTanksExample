  ...
  const mxArray * prhs[] )
{
  ...
  if (sf_Verification_Component_Primitive_replacement_process_check_sum_call
      (nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_Verification_Component_Primitive_replacement_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "Verification_Component_Primitive_replacement") == 0)
  {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Verification_Component_Primitive_replacement_autoinheritance_info
      (nlhs,plhs,3,newRhs);
  }
...
extern unsigned int
  sf_Verification_Component_Primitive_replacement_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Verification_Component_Primitive_replacement")) {
    return(sf_Verification_Component_Primitive_replacement_method_dispatcher
...
extern void Verification_Component_Primitive_replacement_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    Verification_Component_Primitive_replacement_terminator();
    sf_debug_terminate();
  }
...
extern void Verification_Component_Primitive_replacement_initializer(void);
extern void
  Verification_Component_Primitive_replacement_register_exported_symbols
  (SimStruct* S);
extern void Verification_Component_Primitive_replacement_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Verification_Component_Primitive_replacement_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      Verification_Component_Primitive_replacement_debug_initialize();
    }

    Verification_Component_Primitive_replacement_initializer();
  }
