...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_Properties_Tank2_Primitives_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Properties_Tank2_Primitives_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_Properties_Tank2_Primitives_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "Properties_Tank2_Primitives") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Properties_Tank2_Primitives_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_Properties_Tank2_Primitives_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "Properties_Tank2_Primitives") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Properties_Tank2_Primitives_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
...
extern unsigned int sf_Properties_Tank2_Primitives_method_dispatcher(SimStruct
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Properties_Tank2_Primitives")) {
    return(sf_Properties_Tank2_Primitives_method_dispatcher(simstructPtr,
...
extern void Properties_Tank2_Primitives_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    Properties_Tank2_Primitives_terminator();
    sf_debug_terminate();
  }
...
extern void Properties_Tank2_Primitives_initializer(void);
extern void Properties_Tank2_Primitives_register_exported_symbols(SimStruct* S);
extern void Properties_Tank2_Primitives_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Properties_Tank2_Primitives_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      Properties_Tank2_Primitives_debug_initialize();
    }

    Properties_Tank2_Primitives_initializer();
  }
